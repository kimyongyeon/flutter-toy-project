...
import 'package:toy_project/pages/airbnb/component/common/common_form_field.dart';
  ...
  _buildFormTitle() {
    return Column(
      children: [
        ...
        Text("혼자하는 여행에 적합한 개인실부터 여럿이 함께하는 여행에 좋은 '공간전체' 숙소까지, 모두의 숙소에 다 있습니다.", style: body1(),),
